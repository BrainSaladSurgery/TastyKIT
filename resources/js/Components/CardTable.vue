<template>
    ...
    <div class="w-full h-full flex flex-col justify-center items-center">
        <article  class=" rounded-lg transform rotate-45 shadow-lg w-32 h-32  bg-blue-400 border-2 border-gray-400 ">
            <div  @click="modalModify();modalData(data.id)" class="w-full h-full flex justify-center items-center hover:bg-gray-500 hover:object-cover">
                <!-- <img class="object-contain" :src="data.image" alt="imagen del producto"> --> <h1 class="transform -rotate-45 text-white font-bold uppercase">{{ data.name }}</h1>
            </div>
