    ...
    <nav aria-label="top bar" class="flex-none flex justify-between bg-white h-16">
        ...
        <ul aria-label="top bar right" aria-orientation="horizontal" class="px-8 flex items-center">
            <dropdown>
                <template #trigger>
                    <li class="relative">
                        <input title="Search Bar" v-model="search" @keyup="dataSearch(tipo)" aria-label="search bar" role="search" class="pr-8 pl-4 py-2 rounded-md cursor-pointer focus:border-black focus:cursor-text w-48 placeholder-gray-500" type="text" placeholder="Buscar producto..." />
