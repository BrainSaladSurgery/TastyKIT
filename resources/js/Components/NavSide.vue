<template>
    <nav aria-label="side bar" aria-orientation="vertical" class="flex-none flex flex-col items-center text-center bg-yellow-700  text-gray-100 border-r h-screen">
      ...
      <ul>
        ...
        <li>
            <a title="Drinks" href="#customer-lists" class="h-16 px-6 flex items-center hover:text-white w-full">
            <i class="ml-1">
        ...
        <li>
            <a title="Olla" href="#reporting" class="h-16 px-6 flex items-center hover:text-white w-full">
            <i class="mx-auto">
        ...
        <li>
            <a title="Stock" href="#reporting" class="h-16 px-6 flex items-center hover:text-white w-full">
            <i class="mx-auto">
        ...
        <li>
          <a title="bandeja" href="#admin" class="h-16 px-6 flex items-center hover:text-white w-full">
            <i class="mx-auto">
        ...
        <li>
          <a title="Mesa" href="#admin" class="h-16 px-6 flex  hover:text-white w-full">
            <i class="mx-auto">
        ...
        <li>
          <a title="Users" href="#admin" class="h-16 px-6 flex  hover:text-white w-full">
            <i class="mx-auto">
        ...
        <li>
            <a title="Factura" href="#reporting" class="h-16 px-6 flex items-center hover:text-white w-full">
            <i class="mx-auto">
        ...
        <li>
            ...
            <i class="mx-auto">
                <svg class="fill-current h-7 w-7 hover:text-gray-300" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
