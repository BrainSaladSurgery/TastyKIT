<template>
    <jet-action-section>
        <template #title>
            <b class="text-gray-500">Sesiones del navegador</b>
        </template>

        <template #description>
            <p class="text-gray-500">Administre y cierre la sesión de sus sesiones activas en otros navegadores y dispositivos.</p>
        </template>
