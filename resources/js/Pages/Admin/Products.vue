<template>
  <app-layout>
    ...
    <nav-top @changeModal="showModalMod = $event" @productData="productID = $event">
        <ul id="add" role="listbox" class="outline-none py-2 bg-white  border rounded-md w-48 max-w-md w-dropdown-large shadow-lg focus:outline-none leading-relaxed">
            ...
            <li role="option"  @click="changeStateModal" class="px-6 py-1 my-1 focus:outline-none  focus:bg-gray-100 hover:bg-gray-100 cursor-pointer">
                Product
            </li>
            <li role="option" class="px-6 py-1 my-1 focus:outline-none  focus:bg-gray-100 hover:bg-gray-100 cursor-pointer">
                Drink
            </li>
            <li role="option" class="px-6 py-1 my-1 focus:outline-none  focus:bg-gray-100 hover:bg-gray-100 cursor-pointer">
                User
        ...
        <section aria-label="main content" class="flex  flex-col flex-auto border-l bg-gray-100">
            ...
            <div v-if="productos.length > 0" id="grid" >
                    ...
                    <div  v-for="(product,index) in productos" @key="index" class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/3 ">
                        ...
                        <!-- Article -->
                        <card-product :producto="product" class="bg-white"/>
                <!-- END Article -->
                    </div>
                    ...
                    <modal class="flex flex-col w-11/12 sm:w-5/6 lg:w-1/2 max-w-2xl mx-auto rounded-lg border border-gray-300 shadow-xl" :show="showModal" @close="changeStateModal">
                        <div>
                            ...
                            <div class="flex flex-col m-5 sm:flex-row items-center mb-5 sm:space-x-5">
                                ...
                                <select v-model="productCategory" type="text" name="category" class="w-full p-2 bg-white border border-gray-200 rounded shadow-sm appearance-none focus:ring-0 focus:border-gray-500">
                    ...
                    <modal class="flex flex-col w-11/12 sm:w-5/6 lg:w-1/2 max-w-2xl mx-auto rounded-lg border border-gray-300 shadow-xl" :show="showModalMod" @close="changeStateModalMod">
                        <div>
                            ...
                            <div class="flex flex-col m-5 sm:flex-row items-center mb-5 sm:space-x-5">
                                ...
                                <div class="w-full sm:w-1/3 mt-2 sm:mt-0">
                                    <p class="mb-2 font-semibold text-gray-700">Categoría</p>
                                <select v-model="produc.product_categories_id" type="text" name="category" class="w-full p-2 bg-white border border-gray-200 rounded shadow-sm appearance-none focus:ring-0 focus:border-gray-500" required >
                                    <option value="2">Vegetales</option>
                                    <option value="3">Carnes</option>
                                    <option value="4">Frutas</option>
                                    <option value="5">Pescados</option>
